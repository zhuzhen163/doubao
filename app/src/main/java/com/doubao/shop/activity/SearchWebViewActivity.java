...
public class SearchWebViewActivity extends BaseActivity {
        ...
        setBackListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (webview != null && webview.canGoBack()) {
                    ...
                    AppUtils.hideInputMethod(SearchWebViewActivity.this);
                    SwitchActivityManager.exitActivity(SearchWebViewActivity.this);
                }
    ...
    protected void initView() {
        ...
        webview.addJavascriptInterface(new WebViewClickInterface(SearchWebViewActivity.this),"android");
        clearCookie();
        if ( webview != null){
            ...
            webview.loadUrl(loadUrl+"&token="+ConfigUtils.getToken(), extraHeaders);
        }
        registerTimer();
    }
