package com.doubao.shop.widget.addresspicker;
...
public class AddressPickerView extends RelativeLayout implements View.OnClickListener {
    ...
    private int defaultSelectedColor = Color.parseColor("#800000");
    ...
    private void init(Context context) {
        ...
        // 确定
        mTvSure = (TextView) rootView.findViewById(R.id.tv_Sure);
